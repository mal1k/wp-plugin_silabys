...
function myos_contacts_page_handler()
{
    ...
    if ('delete' === $table->current_action()) {
        $message = '<div class="updated below-h2" id="message"><p>' . sprintf(__('Items deleted: %d', 'myos'), count($_REQUEST['id'])) . '</p></div>';
    }
    ?>
<div class="wrap">

    <div class="icon32 icon32-posts-post" id="icon-edit"><br></div>
    <h2><?php _e('Сілабуси', 'myos')?> <a class="add-new-h2"
                                 href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=silabys_form');?>"><?php _e('Додати сілабус', 'myos')?></a>
    </h2>
    <?php echo $message; ?>
...
function myos_contacts_form_page_handler()
{
    ...
    add_meta_box('contacts_form_meta_box', __('Сілабус форма', 'myos'), 'myos_contacts_form_meta_box_handler', 'contact', 'normal', 'default');

    ?>
<div class="wrap">
    <div class="icon32 icon32-posts-post" id="icon-edit"><br></div>
    <h2><?php _e('Додати сілабус', 'myos')?> <a class="add-new-h2"
                                href="<?php echo get_admin_url(get_current_blog_id(), 'admin.php?page=silabys');?>"><?php _e('Назад до сілабусів', 'myos')?></a>
    </h2>
